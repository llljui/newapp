 ...
 * @name:       xg-base-js
 * @author:     yaoboqin
 * @email:      55973438@qq.com
 * @version:    v1.0.0
 * @buildTime:  2015-06-25
 * @remarks: thanks [tbtx](https://github.com/tbtx)
 */
...
define("request", ["jquery"], function($) {
    ...
    var config = _config("request"),
        ...
        send = function(options, successCode, defer) {
            ...
            isTokenLock = 1;
            options.data._csrf = $('input[name="_csrf"]').val() || generateToken();
            $.ajax(options)
            .done(function(response) {
                ...
                if (response) {
                    ...
                    if(response.redirect && code !== successCode){ 
            ...
            .fail(function(xhr, status, err) {
                defer.reject(code.fail, {
                    code: code.fail,
                    url: options.url,
                    error: msg[xhr.status] || msg[status] || msg.def
                });
            })
            .always(function() {
                isTokenLock = 0;
...
})(typeof window !== "undefined" ? window : this, document, "xg");